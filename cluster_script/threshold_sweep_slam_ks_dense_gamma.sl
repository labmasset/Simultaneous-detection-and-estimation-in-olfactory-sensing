...
#SBATCH --output=logs/threshold_sweep/auc/slam_ks_dense_gamma/%A_%a.out
...
srun python -m mirrored_langevin_rnn.run configs/threshold_sweep_slam_ks_dense_gamma.yaml
